...
public class AliyunOSSClientUtils {
	...
	// accessKey
	private String accessKeyId = "LTAI4FfGNReYDpUxhR3FV8Mk";
	private String accessKeySecret = "Sl8wIOcYd4wb0QtBoLYmJHlfBz8NdM";
	// 空间
	private String bucketName = "jsf110";
	// 文件存储目录
	private String filedir = "aisile/";
